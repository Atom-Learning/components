...
tabs:
  ...
  - title: Usage
    content: >-
      ...
      There's the option to add a [Tooltip](/surfaces/tooltip) for extended information. The user can click/hover the title of the alert to read more details of the message.
