...
To properly retrieve error in both normal and dynamic field it is necessary to use useFieldError hook stored in the form directory, that accepts a field name parameter.
