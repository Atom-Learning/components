...
The component provides a set of default styles, which can be overwritten by using the `css` prop. It is composed by combining smallar components, such as `Tabs.TriggerList`, `Tabs.Trigger`, and `Tabs.Content`.
...
<Tabs>
  <Tabs.TriggerList>
    <Tabs.Trigger value='tab1'>Tab 1</Tabs.Trigger>
    <Tabs.Trigger disabled value='tab2'>Tab 2</Tabs.Trigger>
  <Tabs.TriggerList>
  <Tabs.Content value="tab1">Content for tab 1</Tabs.Content>
