...
NOTE: spacing should not be applied to the `Accordion.Content`, and should instead be applied to child components. Otherwise, the animation will not display correctly.
...
<Accordion type="single" defaultValue="1">
  <Accordion.Item value="1">
    ...
    <Accordion.Content>
      <Text css={{ p: '$2', height: '100px' }}>Some content here</Text>
    </Accordion.Content>
  </Accordion.Item>
  <Accordion.Item value="2">
    <Accordion.Trigger>Accordion Header 2</Accordion.Trigger>
    <Accordion.Content>
      <Text css={{ p: '$2', height: '150px' }}>
        Slightly larger content here
      </Text>
    </Accordion.Content>
  </Accordion.Item>
</Accordion>
