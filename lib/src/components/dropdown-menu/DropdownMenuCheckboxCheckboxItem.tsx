...
import { indicatorStyles, checkboxStyles } from '../checkbox/Checkbox'
...
const StyledDropdownMenuCheckboxCheckboxItemIndicator = styled(ItemIndicator, indicatorStyles)
