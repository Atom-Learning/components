---
title: Tooltip
component: Tooltip,Tooltip.Trigger,Tooltip.Content,Tooltip.Provider
...
`Tooltip.Provider` is optional and provides some global configuration for all `Tooltips` rendered within. 
