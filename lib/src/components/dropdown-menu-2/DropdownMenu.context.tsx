...
export const DropdownMenuProvider: React.FC<IDropdownMenuProps> = ({
  ...
  const [contentRef, setContentRef] = useCallbackRefState() // typeahead trigger?
  ...
  const value = React.useMemo<IDropdownMenuContext>(
    () => ({ isOpen: forceOpen || isOpen, setIsOpen, contentRef, setContentRef, selected, updateSelected, checkSelected }),
    [forceOpen, isOpen, setIsOpen, contentRef, setContentRef, selected, updateSelected, checkSelected]
  )
  return (
