---
title: Sidedrawer
component: Sidedrawer,Sidedrawer.Close,Sidedrawer.Content,Sidedrawer.Footer,Sidedrawer.Header,Sidedrawer.Item,Sidedrawer.Overlay,Sidedrawer.Accordion,Sidedrawer.AccordionContent,Sidedrawer.AccordionTrigger
...
<Sidedrawer isOpen onClose={() => console.log('closed')}>
  ...
  <Sidedrawer.Content>Sidedrawer items and Accordions here</Sidedrawer.Content>
